...
class PartnerLedgerReport(models.AbstractModel):
    _name = 'report.genral_ledger_summary.genral_ledger_report'

    @api.model
    def render_html(self,docids, data=None):

        report_obj = self.env['report']
        report = report_obj._get_report_from_name('genral_ledger_summary.genral_ledger_report')
        ...
        return report_obj.render('genral_ledger_summary.genral_ledger_report', docargs)